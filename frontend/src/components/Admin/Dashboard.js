...
const Dashboard = () => {
  const [stats, setStats] = useState({
    ...
    totalBlogPosts: 0,
    recentBlogPosts: [],
    pendingOrdersCount: 0, // Add pendingOrdersCount
  });
    ...
    axios
      ...
      .then((response) => {
        setStats({
          ...
          pendingOrdersCount: response.data.pendingOrdersCount, // Set pendingOrdersCount
        });
      })
    ...
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:scale-105">
          ...
          <div className="mt-4 text-5xl font-extrabold text-red-600">

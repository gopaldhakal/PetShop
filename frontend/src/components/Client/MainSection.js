    ...
    <main className="relative w-full h-auto bg-[#FFF0D9] py-4">
      ...
      >
        <div className="relative flex flex-col items-center justify-center w-1/2">
          <div className="w-80 h-80 bg-[#FFD6A0] rounded-full flex justify-center items-center relative">
            <img
              src="/cor.png"
              alt="Corgi"
              className="object-cover w-72 h-72 rounded-full shadow-lg"
            />
            <div
              className="absolute mb-16 right-20 flex items-center justify-center"
              style={{ transform: "translateX(50%)" }}
            >
              <span className="text-2xl font-bold text-pink-400">Hello!</span>
            </div>
          </div>
          <p
